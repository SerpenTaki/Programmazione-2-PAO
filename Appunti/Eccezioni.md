...
*C++11 ha eliminato la possibilità di elencare i tipi di eccezione nel throw (test a run-time troppo esteso e non funziona con i template, quindi deprecato).*